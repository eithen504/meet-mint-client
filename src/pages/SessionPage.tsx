...
import { useEndSession, useJoinSession, useSessionById } from "../hooks/session";
...
import useStreamClient from "../hooks/streamClient";
...
function SessionPage() {
    ...
    const [code, setCode] = useState<string | undefined>(problemData?.starterCode?.[selectedLanguage] || "");
    ...
    const handleLanguageChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        const starterCode = problemData?.starterCode?.[newLang as Language] || "";
        setCode(starterCode);
        setOutput(null);
    };
